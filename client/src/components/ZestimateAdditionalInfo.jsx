        ...
        <AdditionalZestimateInformation>
          <ZestDeepDive>
            <ZestDeepDiveIntro>
              ...
              <ZestDeepDiveIntroContent>
                The Zestimate is Zillow’s best estimate of a home’s value. It is
                based on a blend of valuation methods, each of which may produce
                a different estimate depending on the available data.
              </ZestDeepDiveIntroContent>
            </ZestDeepDiveIntro>
            <ZestDeepDiveIntroEstimate>
              Estimate based on
            ...
            <ZestDeepDiveCollapsible>
              ...
              {!this.state.isHiddenMarketAppreciation && (
                <MarketAppreciation marketAppreciationData={propertyData} />
              )}
              <ZestDeepDiveButton
              ...
              {!this.state.isHiddenLocalHomes && (
                <LocalHomes localHomesData={localHomesData} />
              )}
              <TableContainer>
